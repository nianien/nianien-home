export const zh = {
  ...
  about: {
    title: '关于我们',
    body: '念音科技成立于 2026 年，总部位于北京。我们致力于让 AI 拥有你的专属记忆——不是做聪明的工具，而是做能看见你、听到你、理解你的智能体。',
  },
  contact: {
    title: '联系我们',
    emailLabel: '邮箱',
...
export const en: Dict = {
  ...
  about: {
    title: 'About',
    body: 'Nianien Technology was founded in 2026 and is headquartered in Beijing. We’re devoted to giving AI a memory that’s truly yours — not a clever tool, but an agent that can see you, hear you, and understand you.',
  },
  contact: {
    title: 'Contact',
    emailLabel: 'Email',
